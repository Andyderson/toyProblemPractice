...
var hasCycle = function(linkedList) {
  var nodeCon1 = linkedList;
  var nodeCon2 = linkedList;
  var connect = true;

  while ((nodeCon2 = nodeCon2.next)) {
    //If node === node, return true
    if (nodeCon1 === nodeCon2) {
      return true;
    }
    nodeCon1 = connect ? nodeCon1 : nodeCon1.next;
    //console.log('THIS IS NODECON1', nodeCon1);
    connect = !connect;
  }
  return false;
};
